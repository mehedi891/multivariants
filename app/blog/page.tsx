              ...
              <ul className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3" role="list">
                {posts.map((post) => (
                  <li key={post.slug} className="h-full">
                    <Link
                      href={`/blog/${post.slug}`}
                      className="group/card block h-full overflow-hidden rounded-[20px] border border-white/[0.11] bg-[#0d1730]/76 transition-all duration-300 hover:-translate-y-1 hover:border-primary/45 hover:shadow-[0_18px_44px_rgba(42,121,212,0.26)]"
                    >
